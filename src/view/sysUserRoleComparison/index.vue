  ...
  <div>
    ...
    <el-card style="float: left; width: 49%; heigth: 100%">
      ...
      <div>
        ...
        <div>
          <el-table :data="tableData" style="width: 100%; height: 100%" border row-key="UserId" highlight-current-row
                    @current-change="getRoleByUserId">
    ...
    <el-card style="float: right; width: 50%; heigth: 100%">
      ...
      <div>
        <el-tree ref="roleTree" :data="this.treeData" node-key="RoleId" show-checkbox :props="this.defaultProps"
